import { createContext, forwardRef, createElement, Component, Children, isValidElement, cloneElement } from 'react';
import { getLogger } from '@optimizely/js-sdk-logging';
import hoistNonReactStatics from 'hoist-non-react-statics';
import { createInstance as createInstance$1 } from '@optimizely/optimizely-sdk';
...
var logger$2 = getLogger('<OptimizelyFeature>');
...
var logger$3 = getLogger('<OptimizelyExperiment>');
 ...
 * limitations under the License.
 */
var logger$4 = getLogger('ReactSDK');
/**
...
export { OptimizelyContextConsumer, OptimizelyContextProvider, OptimizelyExperiment, OptimizelyFeature, OptimizelyProvider, OptimizelyVariation, createInstance, logOnlyEventDispatcher, withOptimizely };
